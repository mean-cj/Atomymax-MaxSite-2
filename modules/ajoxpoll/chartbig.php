...
$shadow_height = 15; // Height on shadown.
...
{
	if ($data[$i]/array_sum($data) < 0.01) $number[$i] = ' '.number_format(($data[$i]/array_sum($data))*100,2,'.','.').'%';
...
if(ISO =='utf-8'){
imagettftext($img, 15, 0, $width+20, $label_place+10, $black, $font, $label_output);
} else {
imagettftext($img, 15, 0, $width+20, $label_place+10, $black, $font, iconv("TIS-620","UTF-8",$label_output));
}
$label_output = '';
	$label_place = $label_place + 18;
}
}
