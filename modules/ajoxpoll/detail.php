...
$q = mysql_query("select * from ".TB_POLL." where status='1' order by id desc limit 1");
...
////**********************************
$qz = mysql_query("select * from ".TB_POLL_VOTES." where ip = '$sess_id' and poll_id ='$pid' ");
$rz = mysql_num_rows($qz);
