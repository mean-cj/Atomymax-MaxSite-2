...
<?php
	...
	require_once('modules/smiletag/lib/domit/xml_domit_lite_include.php');
	require_once('modules/smiletag/lib/St_XmlParser.class.php');	
	require_once('modules/smiletag/lib/St_ConfigManager.class.php');
	require_once('modules/smiletag/lib/St_FileDao.class.php');
	require_once('modules/smiletag/lib/St_PersistenceManager.class.php');
	require_once('modules/smiletag/lib/St_InputProcessor.class.php');
	require_once('modules/smiletag/lib/St_AdminManager.class.php');
	...
	*/
	function actionRedirect($action_target,$param){
		...
		if($action_target == 'messages'){
			$target_url = '?name=admin&file=smiletag&show=messages';
		}elseif ($action_target == 'edit_message'){
			$target_url = '?name=admin&file=smiletag&show=edit_message';
		}elseif ($action_target == 'moderation'){
			$target_url = '?name=admin&file=smiletag&show=moderation';
		}elseif ($action_target == 'edit_message_moderation'){
			$target_url = '?name=admin&file=smiletag&show=edit_message_moderation';
		}elseif ($action_target == 'ban'){
			$target_url = '?name=admin&file=smiletag&show=ban';
		}elseif ($action_target == 'smilies'){
			$target_url = '?name=admin&file=smiletag&show=smilies';
		}elseif ($action_target == 'badwords'){
			$target_url = '?name=admin&file=smiletag&show=badwords';
		}elseif ($action_target == 'configuration'){
			$target_url = '?name=admin&file=smiletag&show=configuration';
		}
