...
CheckAdmin($_SESSION['admin_user'], $_SESSION['admin_pwd']);
	...
	if(!empty($messageArray)){
		foreach ($messageArray as $key=>$value){
			...
			$messageArray[$key]['message'] =  str_replace('<img src="images/smilies/','<img src="modules/smiletag/images/smilies/',$messageArray[$key]['message']);
		}
	}
	
	/*********************************************************************/
	require_once('modules/smiletag/admin/localMessage.php');
?>	
    	  <form action="?name=admin&file=smiletag&files=adminProcess" method="post">
...
?>
			  <tr <?php echo $style; ?>>
				...
				<td width="8%" align="center"><a href="?name=admin&file=smiletag&show=edit_message_moderation&id=<?php echo $value['datetime']; ?>">Edit</a></td>
