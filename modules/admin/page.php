...
//echo $arr['page']['links'];
                                                if ($arr['page']['links']) {
                                                    echo '<a href=' . $arr['page']['proto'] . '' . $arr['page']['links'] . ' target=' . $arr['page']['target'] . ' >' . $arr['page']['menuname'] . '</a>';
                                                } else {
                                                    echo '<a href="?name=page&file=page&op=' . $arr['page']['name'] . '"> ' . $arr['page']['menuname'] . '</a>';
                                                }
                                                echo '';
                                                ?></td>
                                                <td ><CENTER><? echo $arr['page']['menugr']; ?></CENTER></td>
                                            <td ><CENTER><? if ($arr['page']['links'] != '') {
                                                    echo "<font color=#00CC00><b>LINK</font></b>";
                                                } else {
                                                    echo "<font color=#CC0000><b>PAGE</font></b>";
                                                } ?></CENTER></td>

                                            <td ><CENTER><? if ($arr['page']['status'] == '1') {
                                                    echo "<a HREF=?name=admin&file=page&op=page_update&action=update&id=" . $arr['page']['id'] . "&status=0><img src=images/tick.png></a>";
                                                } else if ($arr['page']['status'] == '0') {
                                                    echo "<a HREF=?name=admin&file=page&op=page_update&action=update&id=" . $arr['page']['id'] . "&status=1><img src=images/publish_x.png></a>";
                                                } ?></CENTER></td>
...
// ระบบค้นหาบทความของ maxsite 1.10 พัฒนาโดย www.narongrit.net
                                        ...
                                        <B>Protocal : </B>
                                        <select name="PROTO" >
                                            <option value="http://" <? if ($arr['page']['proto'] == 'http://') {
                                        echo " Selected";
                                    } ?>>http://</option>
                                            <option value="https://" <? if ($arr['page']['proto'] == 'https://') {
                                        echo " Selected";
                                    } ?>>https://</option>
                                            <option value="ftp://" <? if ($arr['page']['proto'] == 'ftp://') {
                                        echo " Selected";
                                    } ?>>ftp://</option>
                                            <option value="" <? if ($arr['page']['proto'] == '') {
                                        echo " Selected";
                                    } ?>>--orther--</option>
                                        </select><B> Url : </B><INPUT TYPE="text" NAME="LINKS" size="50" value="<?= $arr['page']['links']; ?>">
                                        <B>taget : </B>
                                        <select name="TARGET" >
                                            <option value="" <? if ($arr['page']['target'] == '') {
                                        echo " Selected";
                                    } ?>>-- noset--</option>
                                            <option value="_blank" <? if ($arr['page']['target'] == '_blank') {
                                        echo " Selected";
                                    } ?>>New Window</option>
                                            <option value="_top" <? if ($arr['page']['target'] == '_top') {
                                echo " Selected";
                            } ?>>Topmost Window</option>
                                            <option value="_seft" <? if ($arr['page']['target'] == '_seft') {
                                echo " Selected";
                            } ?>>Same Window</option>
                                            <option value="_parent" <? if ($arr['page']['target'] == '_parent') {
                                echo " Selected";
