...
$MaxFileSize = "5120000"; // max file size in bytes
...
$dirroot[1]=''.WEB_PATH.'/';
$dirpath[1]=''.WEB_PATH.'/';
$nav[1]='<a href="?name=admin&file=filemanager&u=$u&copt=2">Note files</a> | Test files';
...
$nav[2]='Note  files | <a href="?name=admin&file=filemanager&u=$u&copt=1">Test files</a>';
...
if ($user == $u) {
	...
	//    $navbar .= "<font face=verdana size=1> | <a href=\"$PHP_SELF?name=admin&file=filemanager\">logout</a></font>";
}
if ($back) {
...
//                        @copy($_FILES['uploadedfile']['tmp_name'], $path.$pathext.$_FILES['uploadedfile']['name'].$OffExt); 
            ...
            $msg =  "<font face='Verdana, Arial, Hevetica' size='2' color='#ff0000'>"._ADMIN_FILEMANAGER_UPLOAD_SELECT_FILE."</font><p>";
        }
    ...
    elseif($delete) {
        ...
        if (TargetOK($delete)) {
            ...
            if(is_dir($path.$pathext.$delete)) {
                ...
                if($result == 0) {
                    $msg = "<font face='Verdana, Arial, Hevetica' size='2' color='#ff0000'>"._ADMIN_FILEMANAGER_UPLOAD_NODEL."</font><p>";
                }
            }
            else {
...
endupform;
    ...
    */
    ...
    if($pathext) {
        $filemanager  .= <<<content
        <tr>
            <td bgcolor="#ffffff" align=center><img src="modules/filemanager/fm_files/parent.gif" width="20" height="20" border=0></td><td>&nbsp;<a href="$PHP_SELF?name=admin&file=filemanager&u=$u&back=1&sortKey=$sortKey&pathext=$pathext&copt=$copt"><font face="Verdana, Arial, Helvetica" size="2" color="#666666">&laquo;BACK</font></a>&nbsp;</td>
...
content;
    ...
    */
    ...
    for($i = 0; $i < (count($fileattrib)); $i++) {
        ...
        if (TargetOK($file)) {
            $deletelink = "<a href=\"$PHP_SELF?name=admin&file=filemanager&delete=$file&copt=$copt&sortKey=$sortKey&u=$u&pathext=$pathext\" title=\"DELETE $file\"><font face=\"Verdana, Arial, Helvetica\" size=\"1\" color=\"#FF0033\"><b>DEL</b></font></a>";
            if ($filetype=="OFF") { 
                $renamelink="---";
            }
            else {
                    $renamelink = "<a href=\"$PHP_SELF?name=admin&file=filemanager&file=fm&rename=$file&copt=$copt&sortKey=$sortKey&u=$u&pathext=$pathext\" title=\"Rename $file\"><font face=\"Verdana, Arial, Helvetica\" size=\"1\" color=\"#666666\">REN</font></a>";
            }
        }
        else {
            $deletelink = "---";
        ...
        if($EditOn && $filetype != "Folder")  {
            if (Ok2Edit($fileattrib[$i][3])) {
                if (TargetOK($file)) {
                    $editlink =     "<a href=\"$PHP_SELF?name=admin&file=filemanager&edit=$file&u=$u&copt=$copt&pathext=$pathext\"><font face='Verdana, Arial, Helvetica' size='1' color='#666666' title=\"Edit $file\"><b>EDIT</b></font></a>";
                }
                else {
                    $editlink = "---";
                }
        ...
        if ($filetype != "Folder" && TargetOK($file)) {
            $cpmv =     "<a class=5c title=\"Copy or Move $file\" href=\"$PHP_SELF?name=admin&file=filemanager&cpmv=$file&u=$u&copt=$copt&pathext=$pathext\"><font face='Verdana, Arial, Helvetica' size='1' color='#666666'><b>CpMv</b></font></a>";
        }
...
content;
    ...
    <form name="form1" method="post" action="$PHP_SELF?name=admin&file=filemanager" id="form1" enctype="multipart/form-data" >$msg
        </td>
    </tr>
    <tr>
...
function renform() {
    ...
    <form name="form1" method="post" action="$PHP_SELF?name=admin&file=filemanager" enctype="multipart/form-data" >
...
function cpmvform($t) {
    ...
    <tr><td colspan=3 align=center>
        ...
        <table cellpadding=0 cellspacing=3 border=0><tr><form method=post action="$PHP_SELF?name=admin&file=filemanager" enctype="multipart/form-data" >
...
function ascedit ($edit) {    
    ...
    <form name="form1" method="post" action="$PHP_SELF?name=admin&file=filemanager" enctype="multipart/form-data" >
          ...
          Current Directory: /$dirroot[$copt]/$pathext<br>File Editing: <b>$edit</b><p>
            <textarea name="newcontent" cols="100" rows="15">$oldcontent</textarea>
            <br>
            <br>
            <input type="hidden" name="copt" value="$copt">
    ...
    $filemanager = <<<content
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#eeeeee">
            <tr> 
                ...
                <td bgcolor="#0066FF" height="20" align=center>&nbsp;<a href="$PHP_SELF?name=admin&file=filemanager&copt=$copt&u=$u&pathext=$pathext&sortKey=0"><font face="Verdana, Arial, Helvetica" size="2" color="#FFFFFF"><b>$fnl FILENAME $fnr</b></font></a>&nbsp;</td>
                <td height="20" bgcolor="#0066FF" align=center><a href="$PHP_SELF?name=admin&file=filemanager&copt=$copt&u=$u&pathext=$pathext&sortKey=1"><font face="Verdana, Arial, Helvetica" size="2" color="#FFFFFF"><b>$Size</b></font></a></td>
                <td height="20" bgcolor="#0066FF" align=center><a href="$PHP_SELF?name=admin&file=filemanager&copt=$copt&u=$u&pathext=$pathext&sortKey=3"><font face="Verdana, Arial, Helvetica" size="2" color="#FFFFFF"><b>$Type</b></font></a></td>
...
function geticon($filetype,$tida) {
    ...
    elseif ($filetype=="Folder") {
        ...
        $iconlink[1] = "<a href=\"?name=admin&file=filemanager&u=$u&copt=$copt&sortKey=$sortKey&pathext=$pathext$file/\">$file</a>";
    }
    elseif ($filetype=="BMP") {
        $iconlink[0] = "<img src=\"modules/filemanager/fm_files/jpg.gif\" width=\"20\" height=\"20\" border=0 alt=\"$tida\">";
        $iconlink[1] = "<a href=\"$PHP_SELF?name=admin&file=filemanager&action=view&cz=x&filename=$file&pathext=$pathext&u=$u&copt=$copt&sortKey=$sortKey\">$file</a>";
    }
    elseif ($filetype=="JPG") {
        $iconlink[0] = "<img src=\"modules/filemanager/fm_files/jpg.gif\" width=\"20\" height=\"20\" border=0 alt=\"$tida\">";
        $iconlink[1] = "<a href=\"$PHP_SELF?name=admin&file=filemanager&action=view&cz=x&filename=$file&pathext=$pathext&u=$u&copt=$copt&sortKey=$sortKey\">$file</a>";
    ...
    elseif ($filetype=="TXT") {
        ...
        $iconlink[1] = "<a href=\"$PHP_SELF?name=admin&file=filemanager&action=viewascii&filename=$file&pathext=$pathext&u=$u&copt=$copt&sortKey=$sortKey\">$file</a>";
    }
    elseif ($filetype=="LOG") {
        $iconlink[0] = "<img src=\"modules/filemanager/fm_files/txt.gif\" width=\"20\" height=\"20\" border=0 alt=\"$tida\">";
        $iconlink[1] = "<a href=\"$PHP_SELF?name=admin&file=filemanager&action=viewascii&filename=$file&pathext=$pathext&u=$u&copt=$copt&sortKey=$sortKey\">$file</a>";
    ...
    elseif ($filetype=="DOC") {
        ...
        $iconlink[1] = "<a href=\"$PHP_SELF?name=admin&file=filemanager&action=download&filename=$file&pathext=$pathext&u=$u&copt=$copt&sortKey=$sortKey\">$file</a>";
    }
    elseif ($filetype=="PHP") {
...
function viewascii () {        
    ...
    <tr><td colspan=3 align=center>
        <table width=100% border=0>
            ...
            <td>&nbsp;</td>
            <td align=center>
                <a href="$PHP_SELF?name=admin&file=filemanager&u=$u&sortKey=$sortKey&pathext=$pathext&copt=$copt"><font face=Verdana, Arial, Helvetica size=2>&laquo;BACK</font></a>
            </td></tr>
        </table>
        <hr>
                ...
                <td class=normalblack align=center>
                    ...
                    <table cellpadding=1 cellspacing=0 border=0><tr><td bgcolor="#330033">
                        <table width=80% height=100% bgcolor="#ffffff" cellpadding=10 border=0>
                            ...
                            <textarea readonly name="content" rows="20" cols="100" wrap=virtual>$content</textarea>
                        </td>
                            </tr>
                        </table>
                    </td></tr></table>
        ...
        &nbsp;&nbsp;<a href="$PHP_SELF?name=admin&file=filemanager&u=$u&sortKey=$sortKey&pathext=$pathext&copt=$copt"><font face=Verdana, Arial, Helvetica size=2>&laquo;BACK</font></a></p>
    </td></tr>
content;
return $filemanager;
...
function viewimage () {        
    ...
    <tr><td colspan=3>
        ...
        <table border="0" cellspacing="0" cellpadding="0" width=96%>
            <tr>
                <td class=normalblack align=center>
                    <a href="$PHP_SELF?name=admin&file=filemanager&action=view&cz=$cz&za=-1&filename=$filename&pathext=$pathext&u=$u&copt=$copt&sortKey=$sortKey"><img src=modules/filemanager/fm_files/minus.gif width=11 height=11 border=0 alt=Zoom In>&nbsp;Zoom Out</a>&nbsp;<a href="$PHP_SELF?name=admin&file=filemanager&action=view&cz=$cz&za=1&filename=$filename&pathext=$pathext&u=$u&copt=$copt&sortKey=$sortKey"><img src=modules/filemanager/fm_files/plus.gif width=11 height=11 border=0 alt=Zoom Out>&nbsp;Zoom In</a>&nbsp;<a href="$PHP_SELF?name=admin&file=filemanager&action=view&cz=3&za=0&filename=$filename&pathext=$pathext&u=$u&copt=$copt&sortKey=$sortKey"><img src=modules/filemanager/fm_files/original.gif width=11 height=11 border=0 alt=Original Size>&nbsp;Original Size</a>

                    <table cellpadding=1 cellspacing=0 border=0><tr><td bgcolor="#330033">
                        <table width=80% height=100% bgcolor="#ffffff" cellpadding=10 border=0>
                            <tr>
                                <td align=center valign=middle><img src="$pathext$filename" width=$f_width height=$f_height border=0></td>
                            </tr>
                        </table>
                    </td></tr></table>
                    <span class=smallblack>Last Modified: $lastmod</span>
